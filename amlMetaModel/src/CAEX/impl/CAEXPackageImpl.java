...
import GenericAnyType.impl.GenericAnyTypePackageImpl;
...
public class CAEXPackageImpl extends EPackageImpl implements CAEXPackage {
	...
	public static CAEXPackage init() {
		...
		GenericAnyTypePackageImpl theGenericAnyTypePackage = (GenericAnyTypePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(GenericAnyTypePackage.eNS_URI) instanceof GenericAnyTypePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(GenericAnyTypePackage.eNS_URI) : GenericAnyTypePackage.eINSTANCE);
	 ...
	 * @generated
	 */
	public EOperation getCAEXFile__GetAllExternalInterfaces__boolean() {
		return caexFileEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getCAEXFile__GetAllRoleClasses__boolean() {
		return caexFileEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getCAEXFile__GetAllSystemUnitClasses__boolean() {
		return caexFileEClass.getEOperations().get(3);
	}
	 ...
	 * @generated
	 */
	public EReference getExternalReference_LinkedModel() {
	 ...
	 * @generated
	 */
	public EOperation getInterfaceClassLib__GetInterfaceClass__String() {
		return interfaceClassLibEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getInterfaceClass__GetInterfaceClass__String() {
		return interfaceClassEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getRoleClassLib__GetAllRoleClasses() {
		return roleClassLibEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getRoleClassLib__GetRoleClass__String() {
		return roleClassLibEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getRoleClass__GetRoleClass__String() {
		return roleClassEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getSystemUnitClassLib__GetAllSystemUnitClasses() {
		return systemUnitClassLibEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getSystemUnitClass__GetSystemUnitClass__String() {
		return systemUnitClassEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getSystemUnitClass__GetAttribute__String() {
		return systemUnitClassEClass.getEOperations().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEReference(externalReferenceEClass, EXTERNAL_REFERENCE__LINKED_MODEL);
		...
		createEOperation(interfaceClassLibEClass, INTERFACE_CLASS_LIB___GET_INTERFACE_CLASS__STRING);
		...
		createEOperation(interfaceClassEClass, INTERFACE_CLASS___GET_INTERFACE_CLASS__STRING);
		...
		createEOperation(roleClassLibEClass, ROLE_CLASS_LIB___GET_ALL_ROLE_CLASSES);
		createEOperation(roleClassLibEClass, ROLE_CLASS_LIB___GET_ROLE_CLASS__STRING);
		...
		createEOperation(roleClassEClass, ROLE_CLASS___GET_ROLE_CLASS__STRING);
	...
	public void initializePackageContents() {
		...
		GenericAnyTypePackage theGenericAnyTypePackage = (GenericAnyTypePackage)EPackage.Registry.INSTANCE.getEPackage(GenericAnyTypePackage.eNS_URI);
		...
		additionalInformationEClass.getESuperTypes().add(theGenericAnyTypePackage.getGenericElement());
		...
		op = initEOperation(getCAEXFile__GetAllRoleClasses__boolean(), this.getRoleClass(), "getAllRoleClasses", 0, -1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theXMLTypePackage.getBoolean(), "includeExternalReferences", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getExternalReference_LinkedModel(), this.getCAEXFile(), null, "linkedModel", null, 0, 1, ExternalReference.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getInterfaceClassLib__GetInterfaceClass__String(), this.getInterfaceClass(), "getInterfaceClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theXMLTypePackage.getString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getInterfaceClass__GetInterfaceClass__String(), this.getInterfaceClass(), "getInterfaceClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theXMLTypePackage.getString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getRoleClassLib__GetAllRoleClasses(), this.getRoleClass(), "getAllRoleClasses", 0, -1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getRoleClassLib__GetRoleClass__String(), this.getRoleClass(), "getRoleClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theXMLTypePackage.getString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getRoleClass__GetRoleClass__String(), this.getRoleClass(), "getRoleClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theXMLTypePackage.getString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getSystemUnitClass_ExternalInterface(), this.getExternalInterface(), null, "externalInterface", null, 0, -1, SystemUnitClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		op = initEOperation(getSystemUnitClass__GetSystemUnitClass__String(), this.getSystemUnitClass(), "getSystemUnitClass", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theXMLTypePackage.getString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
