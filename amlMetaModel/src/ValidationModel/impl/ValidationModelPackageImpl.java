...
public class ValidationModelPackageImpl extends EPackageImpl implements ValidationModelPackage {
	 ...
	 * @generated
	 */
	public EOperation getValidationError__Equals__EObject() {
	...
	public void createPackageContents() {
		...
		createEOperation(validationErrorEClass, VALIDATION_ERROR___EQUALS__EOBJECT);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getValidationError__Equals__EObject(), ecorePackage.getEBoolean(), "equals", 0, 1, IS_UNIQUE, IS_ORDERED);
