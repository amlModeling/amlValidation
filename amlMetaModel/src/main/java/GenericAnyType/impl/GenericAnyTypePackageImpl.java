...
public class GenericAnyTypePackageImpl extends EPackageImpl implements GenericAnyTypePackage {
	...
	public static GenericAnyTypePackage init() {
		...
		Object registeredGenericAnyTypePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		GenericAnyTypePackageImpl theGenericAnyTypePackage = registeredGenericAnyTypePackage instanceof GenericAnyTypePackageImpl ? (GenericAnyTypePackageImpl)registeredGenericAnyTypePackage : new GenericAnyTypePackageImpl();

		isInited = true;

		// Obtain or create and register interdependencies
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(CAEXPackage.eNS_URI);
		CAEXPackageImpl theCAEXPackage = (CAEXPackageImpl)(registeredPackage instanceof CAEXPackageImpl ? registeredPackage : CAEXPackage.eINSTANCE);
