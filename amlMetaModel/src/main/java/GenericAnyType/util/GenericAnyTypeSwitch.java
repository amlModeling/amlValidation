 ...
 * @generated
 */
public class GenericAnyTypeSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GenericAnyTypePackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case GenericAnyTypePackage.GENERIC_ELEMENT: {
			...
			case GenericAnyTypePackage.GENERIC_ATTRIBUTE: {
