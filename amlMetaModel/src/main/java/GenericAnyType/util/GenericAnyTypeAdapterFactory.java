 ...
 * @generated
 */
public class GenericAnyTypeAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static GenericAnyTypePackage modelPackage;
	 ...
	 * @generated
	 */
	public GenericAnyTypeAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = GenericAnyTypePackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected GenericAnyTypeSwitch<Adapter> modelSwitch =
		new GenericAnyTypeSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link GenericAnyType.GenericAttribute <em>Generic Attribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
