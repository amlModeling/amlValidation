...
public class CAEXPackageImpl extends EPackageImpl implements CAEXPackage {
	...
	public static CAEXPackage init() {
		...
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(GenericAnyTypePackage.eNS_URI);
		GenericAnyTypePackageImpl theGenericAnyTypePackage = (GenericAnyTypePackageImpl)(registeredPackage instanceof GenericAnyTypePackageImpl ? registeredPackage : GenericAnyTypePackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getRoleRequirements_ExternalInterface(), this.getExternalInterface(), null, "externalInterface", null, 0, -1, RoleRequirements.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
